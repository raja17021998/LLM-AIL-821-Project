...
os.makedirs("plots/task3/task3_roberta_base", exist_ok=True)
...
plt.legend()
plt.grid()
plt.savefig("plots/task3/task3_roberta_base/training_validation_loss.png")  
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("plots/task3/task3_roberta_base/validation_accuracy.png") 
print("Val Acc Saved!!")