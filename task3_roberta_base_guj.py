...
plt.legend()
plt.grid()
plt.savefig("/kaggle/working/plots/task3/task3_roberta_guj/training_validation_loss.png")  
plt.show()
...
plt.legend()
plt.grid()
plt.savefig("/kaggle/working/plots/task3/task3_roberta_guj/validation_accuracy.png") 
plt.show()
